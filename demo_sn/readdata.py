...
def dataset(data_name='sets',num_train=4000,sample_lenth=4096,test_rate=0.5):
    train_data_name=['D:/学习/数据集/自家试验台数据/002/4.xlsx',       
                          'D:/学习/数据集/自家试验台数据/010/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/029/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/053/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/014/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/037/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/061/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/006/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/034/4.xlsx',
                          'D:/学习/数据集/自家试验台数据/057/4.xlsx'
                          ]
    ...
    if test_rate==0:
        ...
        io.savemat('extra'+data_name,{'x_test': x_test,'y_test': y_test,})
