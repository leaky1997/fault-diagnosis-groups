...
class Diagnosis():
    ...
    def __init__(self,data_name='sets',n_class=10,lr=0.001,batch_size=64,num_train=100):
        ...
        model=CNNmodel
        self.net=model(input_size=32,class_num=10)
        self.net.cuda()
        self.lr=lr
...
if __name__ == '__main__':
    ...
    diag=Diagnosis(data_name='test',n_class=10,lr=0.001,batch_size=64,num_train=200)
#    diag.fit(100)
    diag.evaluation()
    ...
    diag.evaluation()
#
#    new_data_diag(data_name='extranewdata',num_train=500)
